...
"}")
    ...
    def retranslateUi(self, Review):
        ...
        self.label_choiceClan.setText(_translate("Review", "Оберіть рід:"))
        self.comboBox_choiceClan.setItemText(1, _translate("Review", "surname1"))
        self.comboBox_choiceClan.setItemText(2, _translate("Review", "surname2"))
